...
llm_config = { "config_list": [{ "model": "gpt-4o-mini",    "api_type": "azure", "api_key": '3CB2QgJZUjqD5auZRty7AzdPEzMePwfVcdiockY32rP2mT0zZs6pJQQJ99BDACYeBjFXJ3w3AAAAACOGf4jg' ,"base_url":"https://agenttsgpoc.openai.azure.com/",    "api_version": "2024-12-01-preview"}] }
...
with col1:
    ...
    tsg_input = st.text_area("Put your TSG link for AssistantAgent:", key="left_input")
...
def run_kusto_query(query: str):    
    url = "http://localhost:8080/v1/rest/query"
    headers = {
...
# Register Custom Function for Query Execution
@user_proxy.register_for_execution()
@incident_assistant.register_for_llm(description="Send summary in email ")
